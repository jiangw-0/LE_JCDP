...
def diff_purify(x, diffusion, max_iter, mode, config): #max_iter:4
    ...
    with torch.no_grad():
        ...
        for i in range(max_iter): #4
            ...
            xt = diffusion.diffuse_t_steps(xt_reverse, config.purification.purify_step)#50


            #save_images
            save_path = '/home/jiangwan/dlcode/U_E/GuidedDiffusionPur-main/output'

            save_images(diffusion.diffuse_t_steps(xt_reverse, 400),os.path.join(save_path, 'generate_cifar10/diffuse400'))
            save_images(diffusion.diffuse_t_steps(xt_reverse, 200),os.path.join(save_path, 'generate_cifar10/diffuse200'))
            save_images(diffusion.diffuse_t_steps(xt_reverse, 100),os.path.join(save_path, 'generate_cifar10/diffuse100'))
            save_images(diffusion.diffuse_t_steps(xt_reverse, 0),os.path.join(save_path, 'generate_cifar10/diffuse00'))
            ...
            save_images(x200,'/home/jiangwan/dlcode/U_E/GuidedDiffusionPur-main/output/generate_cifar10/reverse200')
            save_images(x100,'/home/jiangwan/dlcode/U_E/GuidedDiffusionPur-main/output/generate_cifar10/reverse100')
            save_images(x000,'/home/jiangwan/dlcode/U_E/GuidedDiffusionPur-main/output/generate_cifar10/reverse0')
            save_images(xt_reverse,'/home/jiangwan/dlcode/U_E/GuidedDiffusionPur-main/output/generate_cifar10/reverse')
